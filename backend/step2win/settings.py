...
_ALLOW_BOOTSTRAP_SECRET_FALLBACKS = _CURRENT_MANAGEMENT_COMMAND in _MANAGE_PY_BOOTSTRAP_COMMANDS or os.environ.get('DJANGO_BOOTSTRAP') == '1'
...
if not APP_SIGNING_SECRET:
    if _ALLOW_BOOTSTRAP_SECRET_FALLBACKS or DEBUG:
