...
_CURRENT_MANAGEMENT_COMMAND = sys.argv[1] if len(sys.argv) > 1 and (sys.argv[0].endswith('manage.py') or os.path.basename(sys.argv[0]) == 'manage.py') else ''
_ALLOW_BOOTSTRAP_SECRET_FALLBACKS = (_CURRENT_MANAGEMENT_COMMAND in _MANAGE_PY_BOOTSTRAP_COMMANDS) or (os.getenv('GITHUB_ACTIONS') == 'true')
...
STEP_ANTICHEAT_V2_ENABLED = os.getenv('STEP_ANTICHEAT_V2_ENABLED', 'False').strip().lower() == 'true'
STEP_ANTICHEAT_V2_SHADOW_MODE = os.getenv('STEP_ANTICHEAT_V2_SHADOW_MODE', 'True').strip().lower() == 'true'
STEP_ANTICHEAT_V2_VERSION = os.getenv('STEP_ANTICHEAT_V2_VERSION', 'v2')
ANTICHEAT_V2_SUSPICIOUS_STEPS_PER_MIN = float(os.getenv('ANTICHEAT_V2_SUSPICIOUS_STEPS_PER_MIN', '165'))
ANTICHEAT_V2_IMPOSSIBLE_STEPS_PER_MIN = float(os.getenv('ANTICHEAT_V2_IMPOSSIBLE_STEPS_PER_MIN', '240'))
ANTICHEAT_V2_SUSPICIOUS_CADENCE_SPM = float(os.getenv('ANTICHEAT_V2_SUSPICIOUS_CADENCE_SPM', '205'))
ANTICHEAT_V2_IMPOSSIBLE_CADENCE_SPM = float(os.getenv('ANTICHEAT_V2_IMPOSSIBLE_CADENCE_SPM', '245'))
ANTICHEAT_V2_SUSPICIOUS_BURST_5S = int(os.getenv('ANTICHEAT_V2_SUSPICIOUS_BURST_5S', '18'))
ANTICHEAT_V2_IMPOSSIBLE_BURST_5S = int(os.getenv('ANTICHEAT_V2_IMPOSSIBLE_BURST_5S', '28'))
