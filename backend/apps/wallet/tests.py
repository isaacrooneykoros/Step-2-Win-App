...
class WalletIntegrationTests(APITestCase):
    ...
    def test_deposit_initiates_payment_without_crediting_wallet(
        self, mock_initiate_deposit
    ):
        ...
        mock_initiate_deposit.assert_called_once_with(
            self.user, Decimal("150.00"), self.user.phone_number
        )
