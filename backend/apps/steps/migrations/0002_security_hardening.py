    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["user", "is_active"], name="device_reg_user_active_idx"
                    ),
                    models.Index(
                        fields=["device_id"], name="steps_device_device_id_idx"
                    ),
                ],
            },
        ),
        ...
        migrations.CreateModel(
            ...
            options={
                "ordering": ["-created_at"],
                "unique_together": {("user", "session_token_hash")},
                "indexes": [
                    models.Index(
                    ...
                    models.Index(
                        ...
                        name="session_expiry_status_idx",
                    ),
                ],
            },
        ),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="syncevent_session_sq_idx",
                    ),
                    models.Index(
                        fields=["user", "created_at"], name="syncevent_user_created_idx"
                    ),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="review_status_created_idx",
                    ),
                    models.Index(
