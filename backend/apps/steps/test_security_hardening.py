...
class SecurityUtilsTestCase(TestCase):
    ...
    def test_compute_payload_hash(self):
        ...
        payload1 = {
            ...
            'sequence_number': 1,
            'timestamp_client': timezone.now().isoformat(),
            'steps_delta': 100,
            'steps_total': 5000,
...
class DeviceRegistrationTestCase(TestCase):
    ...
    def setUp(self):
        User = get_user_model()
        self.user = User.objects.create_user('testuser', 'test@example.com', 'pass', phone_number='254700000001')
...
class StepSessionTestCase(TransactionTestCase):
    ...
    def setUp(self):
        User = get_user_model()
        self.user = User.objects.create_user('testuser', 'test@example.com', 'pass', phone_number='254700000002')
...
class ReplayDetectionTestCase(TransactionTestCase):
    ...
    def setUp(self):
        User = get_user_model()
        self.user = User.objects.create_user('testuser', 'test@example.com', 'pass', phone_number='254700000003')
        self.device = DeviceRegistration.objects.create(
            user=self.user,
            device_id='device-1',
            platform='android',
...
class UserTrustProfileTestCase(TestCase):
    ...
    def setUp(self):
        User = get_user_model()
        self.user = User.objects.create_user('testuser', 'test@example.com', 'pass', phone_number='254700000004')
...
class SessionScoringTestCase(TransactionTestCase):
    ...
    def setUp(self):
        User = get_user_model()
        self.user = User.objects.create_user('testuser', 'test@example.com', 'pass', phone_number='254700000005')
        self.device = DeviceRegistration.objects.create(
            user=self.user,
            device_id='device-1',
            platform='android',
