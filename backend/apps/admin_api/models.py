...
class SystemSettings(models.Model):
    ...
    withdrawal_processing_time = models.IntegerField(
        default=24, help_text="Expected withdrawal processing time in hours"
    )
    ...
    challenges_enabled = models.BooleanField(
        default=True, help_text="Allow challenge creation"
    )
    ...
    daily_goal_bonus_xp = models.IntegerField(
        default=100, help_text="Bonus XP for reaching daily step goal"
    )

    # Notifications
    admin_email = models.EmailField(
        default="admin@step2win.com", help_text="Admin contact email"
    )
    support_email = models.EmailField(
        default="support@step2win.com", help_text="Support contact email"
    )
    ...
    maintenance_mode = models.BooleanField(
        default=False, help_text="Enable maintenance mode (blocks all user access)"
    )
...
class AuditLog(models.Model):
    ...
    admin = models.ForeignKey(
        "users.User", on_delete=models.SET_NULL, null=True, related_name="admin_actions"
    )
