    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "icon",
                    models.CharField(help_text="Emoji or icon name", max_length=10),
                ),
                (
                    "badge_type",
                    models.CharField(
                ...
                (
                    "color",
                    models.CharField(
                        default="#00F5E9", help_text="Hex color code", max_length=7
                    ),
                ),
                (
                    "criteria_type",
                ...
                (
                    "criteria_value",
                    models.IntegerField(
                        blank=True, help_text="Threshold value for criteria", null=True
                    ),
                ),
            ...
            options={
                ...
                "ordering": ["-created_at"],
                "indexes": [
                    models.Index(fields=["slug"], name="gamificatio_slug_e8a164_idx"),
                    models.Index(
                        fields=["criteria_type"], name="gamificatio_criteri_33b962_idx"
                    ),
                ],
            },
        ),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["user", "level"], name="gamificatio_user_id_ee482c_idx"
                    ),
                    models.Index(fields=["level"], name="gamificatio_level_108b61_idx"),
                ],
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="gamificatio_user_id_683edb_idx",
                    ),
                    models.Index(
                        fields=["badge"], name="gamificatio_badge_i_20a089_idx"
                    ),
                ],
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="gamificatio_user_id_a78f12_idx",
                    ),
                    models.Index(
                        fields=["event_type", "created_at"],
                        name="gamificatio_event_t_793b8a_idx",
                    ),
                    models.Index(
                        fields=["processed", "created_at"],
                        name="gamificatio_process_349e12_idx",
                    ),
                ],
            },
        ),
