...
class Badge(models.Model):
    ...
    badge_type = models.CharField(
        max_length=20, choices=BADGE_TYPES, default="achievement"
    )
    color = models.CharField(
        max_length=7, default="#00F5E9", help_text="Hex color code"
    )
...
class LevelMilestone(models.Model):
    ...
    user = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="level_milestones"
    )
...
class DailyLoginStreak(models.Model):
    ...
    user = models.OneToOneField(
        User, on_delete=models.CASCADE, related_name="login_streak"
    )
