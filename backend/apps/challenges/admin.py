...
from .models import Challenge, ChallengeMessage, ChallengeResult, Participant
...
class ParticipantAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Participant Info", {"fields": ("challenge", "user", "joined_at")}),
        ("Progress", {"fields": ("steps", "qualified", "progress_percentage")}),
        ("Payout", {"fields": ("payout", "rank")}),
    )
