        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    ...
                    models.Index(
                        fields=["order_id"], name="payments_pa_order_i_d65105_idx"
                    ),
                    models.Index(
                        fields=["tracking_reference"],
                        name="payments_pa_trackin_e7a30a_idx",
                    ),
                    models.Index(
                        fields=["status", "type"], name="payments_pa_status_138ec8_idx"
                    ),
                    models.Index(
                        fields=["mpesa_reference"],
                        name="payments_pa_mpesa_r_84c67e_idx",
                    ),
                ],
            },
        ),
